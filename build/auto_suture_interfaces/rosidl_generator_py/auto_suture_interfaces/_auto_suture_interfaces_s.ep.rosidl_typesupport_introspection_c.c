...
static PyMethodDef auto_suture_interfaces__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef auto_suture_interfaces__module = {
  PyModuleDef_HEAD_INIT,
  "_auto_suture_interfaces_support",
  "_auto_suture_interfaces_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  auto_suture_interfaces__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
PyMODINIT_FUNC
PyInit_auto_suture_interfaces_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&auto_suture_interfaces__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
