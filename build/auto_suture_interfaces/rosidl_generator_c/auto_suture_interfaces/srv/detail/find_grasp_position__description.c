...
static char auto_suture_interfaces__srv__FindGraspPosition__TYPE_NAME[] = "auto_suture_interfaces/srv/FindGraspPosition";
static char auto_suture_interfaces__srv__FindGraspPosition_Event__TYPE_NAME[] = "auto_suture_interfaces/srv/FindGraspPosition_Event";
static char auto_suture_interfaces__srv__FindGraspPosition_Request__TYPE_NAME[] = "auto_suture_interfaces/srv/FindGraspPosition_Request";
static char auto_suture_interfaces__srv__FindGraspPosition_Response__TYPE_NAME[] = "auto_suture_interfaces/srv/FindGraspPosition_Response";
...
static char auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__request_message[] = "request_message";
static char auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__response_message[] = "response_message";
static char auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__event_message[] = "event_message";

static rosidl_runtime_c__type_description__Field auto_suture_interfaces__srv__FindGraspPosition__FIELDS[] = {
  {
    {auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__request_message, 15, 15},
    {
  ...
  {
    {auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__response_message, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {auto_suture_interfaces__srv__FindGraspPosition__FIELD_NAME__event_message, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {auto_suture_interfaces__srv__FindGraspPosition_Event__TYPE_NAME, 50, 50},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription auto_suture_interfaces__srv__FindGraspPosition__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Event__TYPE_NAME, 50, 50},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {auto_suture_interfaces__srv__FindGraspPosition__FIELDS, 3, 3},
    },
    {auto_suture_interfaces__srv__FindGraspPosition__REFERENCED_TYPE_DESCRIPTIONS, 10, 10},
  };
  if (!constructed) {
    description.referenced_type_descriptions.data[0].fields = auto_suture_interfaces__srv__FindGraspPosition_Event__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[1].fields = auto_suture_interfaces__srv__FindGraspPosition_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[2].fields = auto_suture_interfaces__srv__FindGraspPosition_Response__get_type_description(NULL)->type_description.fields;
...
static rosidl_runtime_c__type_description__Field auto_suture_interfaces__srv__FindGraspPosition_Response__FIELDS[] = {
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Response__FIELD_NAME__grasp_pose, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription auto_suture_interfaces__srv__FindGraspPosition_Response__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
...
// Define type names, field names, and default values
static char auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__info[] = "info";
static char auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__request[] = "request";
static char auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__response[] = "response";

static rosidl_runtime_c__type_description__Field auto_suture_interfaces__srv__FindGraspPosition_Event__FIELDS[] = {
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__info, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__request, 7, 7},
    {
  ...
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Event__FIELD_NAME__response, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_BOUNDED_SEQUENCE,
      1,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription auto_suture_interfaces__srv__FindGraspPosition_Event__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {auto_suture_interfaces__srv__FindGraspPosition_Request__TYPE_NAME, 52, 52},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {auto_suture_interfaces__srv__FindGraspPosition_Event__TYPE_NAME, 50, 50},
      {auto_suture_interfaces__srv__FindGraspPosition_Event__FIELDS, 3, 3},
    },
    {auto_suture_interfaces__srv__FindGraspPosition_Event__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    description.referenced_type_descriptions.data[0].fields = auto_suture_interfaces__srv__FindGraspPosition_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[1].fields = auto_suture_interfaces__srv__FindGraspPosition_Response__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *auto_suture_interfaces__srv__FindGraspPosition__get_individual_type_description_source(NULL),
    sources[1] = *auto_suture_interfaces__srv__FindGraspPosition_Event__get_individual_type_description_source(NULL);
    sources[2] = *auto_suture_interfaces__srv__FindGraspPosition_Request__get_individual_type_description_source(NULL);
    sources[3] = *auto_suture_interfaces__srv__FindGraspPosition_Response__get_individual_type_description_source(NULL);
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *auto_suture_interfaces__srv__FindGraspPosition_Request__get_individual_type_description_source(NULL),
    constructed = true;
  }
  return &source_sequence;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *auto_suture_interfaces__srv__FindGraspPosition_Response__get_individual_type_description_source(NULL),
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *auto_suture_interfaces__srv__FindGraspPosition_Event__get_individual_type_description_source(NULL),
    sources[1] = *auto_suture_interfaces__srv__FindGraspPosition_Request__get_individual_type_description_source(NULL);
    sources[2] = *auto_suture_interfaces__srv__FindGraspPosition_Response__get_individual_type_description_source(NULL);
