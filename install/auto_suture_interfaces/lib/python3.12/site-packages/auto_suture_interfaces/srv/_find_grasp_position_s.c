...
{
  /* NOTE(esteve): Call constructor of FindGraspPosition_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_suture_interfaces.srv._find_grasp_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FindGraspPosition_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool auto_suture_interfaces__srv__find_grasp_position__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_suture_interfaces.srv._find_grasp_position.FindGraspPosition_Response", full_classname_dest, 74) == 0);
  }
  auto_suture_interfaces__srv__FindGraspPosition_Response * ros_message = _ros_message;
  {  // grasp_pose
...
{
  /* NOTE(esteve): Call constructor of FindGraspPosition_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_suture_interfaces.srv._find_grasp_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FindGraspPosition_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
...
ROSIDL_GENERATOR_C_EXPORT
bool auto_suture_interfaces__srv__find_grasp_position__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_suture_interfaces.srv._find_grasp_position.FindGraspPosition_Event", full_classname_dest, 71) == 0);
  }
  auto_suture_interfaces__srv__FindGraspPosition_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!auto_suture_interfaces__srv__FindGraspPosition_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create auto_suture_interfaces__srv__FindGraspPosition_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    auto_suture_interfaces__srv__FindGraspPosition_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!auto_suture_interfaces__srv__find_grasp_position__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!auto_suture_interfaces__srv__FindGraspPosition_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create auto_suture_interfaces__srv__FindGraspPosition_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    auto_suture_interfaces__srv__FindGraspPosition_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!auto_suture_interfaces__srv__find_grasp_position__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FindGraspPosition_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_suture_interfaces.srv._find_grasp_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FindGraspPosition_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = auto_suture_interfaces__srv__find_grasp_position__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = auto_suture_interfaces__srv__find_grasp_position__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
